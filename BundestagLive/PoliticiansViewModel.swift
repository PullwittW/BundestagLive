...
class PoliticiansViewModel: ObservableObject {
    @Published var politiciansDefault: [DataClassPolitician] = [
        ...
        DataClassPolitician(id: Optional(78886), entityType: Optional("politician"), label: Optional("Katrin Göring-Eckardt"), apiURL: Optional("https://www.abgeordnetenwatch.de/api/v2/politicians/78886"), abgeordnetenwatchURL: Optional("https://www.abgeordnetenwatch.de/profile/katrin-goering-eckardt"), firstName: Optional("Katrin"), lastName: Optional("Göring-Eckardt"), birthName: nil, sex: Optional("f"), yearOfBirth: Optional(1966), party: Optional(BundestagLive.Party(id: 5, entityType: Optional("party"), label: Optional("Bündnis 90/Die Grünen"), apiURL: Optional("https://www.abgeordnetenwatch.de/api/v2/parties/5"))), partyPast: nil, education: nil, residence: nil, occupation: Optional("MdB, Vizepräsidentin des Deutschen Bundestages"), statisticQuestions: Optional(409), statisticQuestionsAnswered: Optional(397), extIDBundestagsverwaltung: Optional("1020"), qidWikidata: Optional("Q48967"), fieldTitle: nil),
